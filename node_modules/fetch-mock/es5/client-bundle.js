(function (global, factory) {
	...
	FetchMock.flush = formatDebug(function () {
		var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(waitForResponseMethods) {
			var queuedPromises;
			return _regenerator2.default.wrap(function _callee$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
	...
	FetchMock.done = formatDebug(function (nameOrMatcher) {
		...
		// break the logging
		var result = routesToCheck.map(function (_ref7) {
